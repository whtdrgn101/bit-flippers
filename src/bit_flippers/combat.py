...
ENEMY_TYPES: dict[str, EnemyData] = {
    ...
    "Comm Overlord": EnemyData(name="Comm Overlord", hp=65, attack=13, defense=6, color=(60, 100, 200), xp_reward=90, money_reward=60, dexterity=5, ability={"name": "Broadcast Override", "status_effect": "Stun", "chance": 0.30}, drop_item="Titanium Arc Saber"),
    # --- Slag Pits ---
    ...
    "Slag Titan": EnemyData(name="Slag Titan", hp=80, attack=15, defense=8, color=(180, 80, 30), xp_reward=110, money_reward=75, dexterity=4, ability={"name": "Slag Wave", "status_effect": "Burn", "chance": 0.35}, drop_item="Palladium Nano Suit"),
    # --- Data Vault ---
